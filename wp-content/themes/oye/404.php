...
<?php echo $theme_opt['body_start_customcode']; ?>
...
<div class="page404">
	<div class="page404-inner">
			...
			<?php endif; ?>
	  		<div class="oops" ><?php echo _e('The page you requested was not found','oyetheme'); ?></div>
	  		<a href="<?php echo site_url(); ?>" class="btn"><?php echo _e('Click here to return','oyetheme'); ?></a>
		</div>
	</div>
</div>
