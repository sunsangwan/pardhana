    ...
    function my_theme_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'required'  => true,
                'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
                // 'external_url' => 'https://downloads.wordpress.org/plugin/meta-box.4.10.3.zip', // If set, overrides default API URL and points to an external URL.
            ),
